...
cc.Class({
    ...
    onLoad () {
        ...
        this.node.on('mousedown', function (event) {
            ...
            clickPos = this.mainCamera.getCameraToWorldPoint(clickPos);
            // cc.log("clickPos",clickPos.toString());
            var newVec2 = this.GameWorldJS.gameWorldNode.convertToNodeSpaceAR(clickPos);
            // cc.log("newVec2",newVec2.toString());
            this.GameWorldJS.crossHair.position = newVec2;
        }, this);
